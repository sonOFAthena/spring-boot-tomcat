...
import com.artion.springboot.app.models.entity.ItemFactura;
...
//    @RequestMapping(value = "/form", method = RequestMethod.POST)
    ...
    public String guardar(@Valid Factura factura,
        ...
        if (itemId == null || itemId.length == 0){
            model.addAttribute("titulo", "Crear Factura");
            model.addAttribute("error", "Error: La factura debe tener facturas asociadas");
            return "factura/form";
        }
...
//        String mensajeFlash = (factura.getId() != null) ? "Factura editada con exito!" : "Factura creada con éxito!";

        clienteService.saveFactura(factura);

        //borra la sesion actual de la factura
        status.setComplete();
